...
package com.sunnyweather.android.flame.master.flame.danmaku.controller;
...
import com.sunnyweather.android.flame.master.flame.danmaku.controller.CacheManagingDrawTask;
import com.sunnyweather.android.flame.master.flame.danmaku.controller.DrawTask;
import com.sunnyweather.android.flame.master.flame.danmaku.controller.IDanmakuViewController;
import com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask;
import com.sunnyweather.android.flame.master.flame.danmaku.controller.UpdateThread;
import com.sunnyweather.android.flame.master.flame.danmaku.danmaku.model.AbsDanmakuSync;
import com.sunnyweather.android.flame.master.flame.danmaku.danmaku.model.AbsDisplayer;
...
import com.sunnyweather.android.flame.master.flame.danmaku.danmaku.renderer.IRenderer.RenderingState;
import com.sunnyweather.android.flame.master.flame.danmaku.danmaku.util.SystemClock;
import com.sunnyweather.android.flame.tv.cjump.jni.DeviceUtils;
...
public class DrawHandler extends Handler {
    ...
    public com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask drawTask;
        ...
        switch (what) {
            ...
            case RESUME:
                ...
                if (mReady) {
                    ...
                    if (drawTask != null) {
                        drawTask.onPlayStateChanged(com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask.PLAY_STATE_PLAYING);
                    }
                } else {
            ...
            case PAUSE:
                ...
                if (drawTask != null) {
                    drawTask.onPlayStateChanged(com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask.PLAY_STATE_PAUSE);
                }
            case QUIT:
                if (what == QUIT) {
...
//                + mCordonTime + ",mFrameRefreshingRate:" + mFrameUpdateRate);
    ...
    private void prepare(final Runnable runnable) {
        if (drawTask == null) {
            drawTask = createDrawTask(mDanmakuView.isDanmakuDrawingCacheEnabled(), timer,
                    ...
                    mDanmakuView.isHardwareAccelerated(), new com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask.TaskListener() {
                        @Override
                        public void ready() {
    ...
    private com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask createDrawTask(boolean useDrwaingCache, DanmakuTimer timer,
                                                                     Context context,
                                                                     int width, int height,
                                                                     boolean isHardwareAccelerated,
                                                                     com.sunnyweather.android.flame.master.flame.danmaku.controller.IDrawTask.TaskListener taskListener) {
