...
package com.sunnyweather.android.flame.tv.cjump.jni;
...
public class NativeBitmapFactory {
    ...
    public static Bitmap createBitmap(int width, int height, Config config) {
        return createBitmap(width, height, config, config.equals(Config.ARGB_4444) || config.equals(Config.ARGB_8888));
    }
    ...
    public static synchronized Bitmap createBitmap(int width, int height, Config config, boolean hasAlpha) {
