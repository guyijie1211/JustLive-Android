...
public class YJSwipeConsumer extends SwipeConsumer implements View.OnClickListener {
    ...
    public YJSwipeConsumer setLeftDrawerView(View drawerView) {
        return setDrawerView(DIRECTION_LEFT, drawerView);
    }
    public YJSwipeConsumer setRightDrawerView(View drawerView) {
        return setDrawerView(DIRECTION_RIGHT, drawerView);
    }
    public YJSwipeConsumer setTopDrawerView(View drawerView) {
        return setDrawerView(DIRECTION_TOP, drawerView);
    }
    public YJSwipeConsumer setBottomDrawerView(View drawerView) {
        return setDrawerView(DIRECTION_BOTTOM, drawerView);
    }
    public YJSwipeConsumer setHorizontalDrawerView(View drawerView) {
        return setDrawerView(DIRECTION_HORIZONTAL, drawerView);
    }
    public YJSwipeConsumer setVerticalDrawerView(View drawerView) {
        return setDrawerView(DIRECTION_VERTICAL, drawerView);
    }
    public YJSwipeConsumer setAllDirectionDrawerView(View drawerView) {
     ...
     * @return this
     */
    public YJSwipeConsumer setDrawerView(int direction, View drawerView) {
     ...
     * @return this
     */
    public YJSwipeConsumer setScrimColor(int color) {
        mScrimColor = color;
        return this;
    }
     ...
     * @return this
     */
    public YJSwipeConsumer setShadowColor(int shadowColor) {
     ...
     * @return this
     */
    public YJSwipeConsumer setShadowSize(int size) {
     ...
     * @return this
     */
    public YJSwipeConsumer setDrawerViewRequired(boolean required) {
    ...
    public YJSwipeConsumer showScrimAndShadowOutsideContentView() {
        this.mShowScrimAndShadowOutsideContentView = true;
        return this;
    }
    public YJSwipeConsumer showScrimAndShadowInsideContentView() {
